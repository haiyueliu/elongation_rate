...
## Normalize coverage to control samples

We suggest to perform DRB/TTchem-seq with control samples in which DRB is not washed out and 4sU is incorporated in the last 5 min of the experiment to capture the background signals.
